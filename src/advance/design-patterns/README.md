...
> 《设计模式》一书曾提到如下文字∶ "考虑你的设计中哪些地方可能变化，这种方式与关注会导致重新设计的原因相反。它不是考虑什么时候会迫使你的设计改变，而是考虑你怎样才能够在不重新设计的情况下进行改变。这里的关键在于封装发生变化的概念，这是许多设计模式的主题。"

这段文字即是《设计模式》提到的"**找到变化并封装之**"。《设计模式》一书中共归纳总结了23 种设计模式。

从**意图/目的**上区分，23种设计模式被分为以下三类
