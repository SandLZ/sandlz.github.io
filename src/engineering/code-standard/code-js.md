...
使用 JavaScript 最合理的方式(Airbnb)。

[原文链接](https://lin-123.github.io/javascript/#%E7%B1%BB%E5%9E%8B)
...
- [19.16](#whitespace--computed-property-spacing) 强制计算特性括号内的间距（不要有空格）。 eslint: [`computed-property-spacing`](https://eslint.org/docs/rules/computed-property-spacing)
